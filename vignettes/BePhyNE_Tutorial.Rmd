...
lets plot some MCMC chains, we can either do that directly for specific parameters using traceplot and dense plot, or plotting all of them using PlotBePhyNEchains()
