...
acceptance_ratio_MV_fun<-function(proposal, current_vals, pa_data, tree, prior, prop, k, prior_only=F, glm_only=F, H_fixed=T){
  ...
  A.prop.bt=lapply(1:length(A.prop), function(x) backTransform1(A.prop[[x]])[1:2])

  A.cur=lapply(1:length(current_vals[[1]][[1]]), function (x) current_vals[[1]][[1]][[x]]$A)
  A.cur.bt=lapply(1:length(A.cur), function(x) backTransform1(A.cur[[x]])[1:2])
  ...
  if (prop<3){
    ...
    if(prop==0){
      ...
      prop.prior.height<-lapply(1:length(proposal), function(pred){
        lapply(missSP, function(sp) Prior_scale[[pred]]$heights.prior[[sp]](startPars_scaled[[1]]$sim_dat$sim_dat_bt[[pred]][sp,3])
        )  }
      )
  ...
  prop.bm.lik=sum(unlist(lapply(1:length(dat.cur), function(x) lnL_ratematrix(dat.prop[[x]], tree, A.prop[[x]], proposal[[x]]$R, H_fixed = H_fixed))))
      ...
      prop.prior.height<-lapply(1:length(proposal), function(pred){
        ...
        lapply(missSP, function(sp){
          if(is.null(Prior[[pred]]$heights.prior)==F){
            ...
            prior[[pred]]$heights.prior[[sp]](startPars_scaled[[1]]$sim_dat$sim_dat_bt[[pred]][sp,3])
          }else{
            0
          }}
        )  }
...
metro_haste_full_MV<- function(R_corr_start,
  ...
  for (w in 1){
    ...
    #i=1
    #tree_full<-tree
    #R_corr_start = startPars_scaled[[i]]$R$R_cor
    #R_sd_start   = startPars_scaled[[i]]$R$R_sd
    #A_start      = startPars_scaled[[i]]$A$A_ft
    #Prior=Prior_scale
    #tree=phylo[[i]]
    #tibble_data = startPars_scaled[[i]]$sim_dat$sim_td
    ...
    A_start_ft<-lapply( 1:length(tibble_data), function(i) forwardTransform1(A_start[[i]])[1:2])
    d<-tuning$niche_prop
    w_mu<-tuning$w_mu
    w_sd<-tuning$w_sd
    v_cor<-tuning$v_cor
    ...
    cur.bm.lik=sum(unlist(lapply(1:length(dat.cur), function(x) lnL_ratematrix(dat.cur[[x]], tree, current_vals[[1]][[1]][[x]]$A, current_vals[[1]][[1]][[x]]$R, H_fixed = H_fixed))))
    ...
    prior.heights.lik=lapply(1:length(current_vals[[1]][[1]]), function(pred){
      lapply(1:length(pa_data), function(sp) Prior[[pred]]$heights.prior[[sp]](dat.cur.bt[[pred]][sp,3])
      )  }
    )
  ...
  for (i in 1:iterations){
    ...
    if (prop==0){
      ...
      if(niche_move==1){
        #proposal= lapply(1:length(td), function(x) Slide_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$center, niche_move = "center"))
        proposal= lapply(1:length(td), function(x) Slide_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$height_slide, niche_move = "height"))
        ...
        #proposal = lapply(1:length(td), function(x) Multiplier_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$center, niche_move = "center"))
        proposal = lapply(1:length(td), function(x) Multiplier_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$height_mult, niche_move = "height"))
      ...
      for(i in 2:length(proposal)){

        proposal[[i]]$td$dat[,3]<-proposal[[1]]$td$dat[,3]
...
metro_haste_full_MV<- function(R_corr_start,
  ...
  for (i in 1:iterations){
    ...
    if(prop<3){
      ...
      for (x in 1:length(dt)){
        missing[[x]]<-(1:nrow(td[[x]]$dat))[tree$tip.label%in%clade$tip.label]
    ...
    if (prop==0){
      ...
      if(niche_move==1){
        #proposal= lapply(1:length(td), function(x) Slide_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$center, niche_move = "center"))
        proposal= lapply(1:length(td), function(x) Slide_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$slide[missing[[x]],3], niche_move = "height", clade))
        ...
        #proposal = lapply(1:length(td), function(x) Multiplier_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$center, niche_move = "center"))
        proposal = lapply(1:length(td), function(x) Multiplier_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$multi[missing[[x]],3],  niche_move = "height", clade))
      ...
      if(niche_move==1){
        ...
        #proposal= lapply(1:length(td), function(x) Slide_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$center, niche_move = "center"))
        proposal= lapply(1:length(td), function(x) Slide_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$slide[missing[[x]],1] , niche_move = "center", clade))
        ...
        #proposal = lapply(1:length(td), function(x) Multiplier_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$center, niche_move = "center"))
        proposal = lapply(1:length(td), function(x) Multiplier_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$multi[missing[[x]],1], niche_move = "center", clade))
        if(center_fixed!=FALSE){
          for (pred in center_fixed){
            proposal[[pred]]$td<-td[[pred]]
          }
      ...
      if(niche_move==1){
        ...
        #proposal= lapply(1:length(td), function(x) Slide_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, H_fixed = H_fixed, d[[x]]))
        proposal= lapply(1:length(td), function(x) Slide_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$slide[missing[[x]],2], niche_move="width", clade))
        ...
        #proposal = lapply(1:length(td), function(x) Multiplier_Proposal_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, H_fixed = H_fixed, d[[x]]))
        proposal = lapply(1:length(td), function(x) Multiplier_Proposal_byClade_byTrait_fn(tree, td[[x]], current_vals[[1]][[1]][[x]]$R, current_vals[[1]][[1]][[x]]$R_cor, current_vals[[1]][[1]][[x]]$R_sd,  current_vals[[1]][[1]][[x]]$A, n, current_vals[[1]][[1]][[x]]$curr.jac, d[[x]]$multi[missing[[x]],2] , niche_move="width", clade))
